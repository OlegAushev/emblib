...
public:
  ...
  {
    static_assert(std::is_invocable_r_v<R, decltype(F), Args...>,
  ...
  {
    static_assert(std::is_invocable_r_v<R, decltype(M), T*, Args...>,
  ...
  friend constexpr bool operator==(delegate const&,
                                   delegate const&) noexcept = default;
};
