...
using value_types =
    typelist<std::int32_t, float, std::array<float, 3>, units::deg_f32>;

inline constexpr auto nvm_layout = nvm::make_layout<value_types>({
    {"motor.pole_pairs", std::int32_t{1}},
    {"motor.R", 0.050f},
    {"gains", std::array{100.f, 200.f, 300.f}},
    {"angle.offset", units::deg_f32{15.0f}},
});
