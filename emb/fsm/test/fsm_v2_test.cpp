...
struct Transitions {
  ...
  static constexpr auto on_event(Switch const&,
                                 OpenState const&,
                                 OpenEvent const&);
  static constexpr auto on_event(Switch const&,
                                 OpenState const&,
...
class Switch
    : public emb::fsm::v2::finite_state_machine<Switch,
...
constexpr auto Transitions::on_event(Switch const& s,
                                     OpenState const&,
                                     OpenEvent const&)
{
  return std::nullopt;
...
struct Transitions {
  ...
  static constexpr auto on_event(Switch&,
                                 ClosedState const&,
                                 CloseEvent const&);
};
...
constexpr auto Transitions::on_event(Switch& s,
                                     OpenState const&,
                                     OpenEvent const&)
{
  return std::nullopt;
...
struct Transitions {
  ...
  static constexpr auto on_event(Switch& s,
                                 State const& state,
                                 DestroyEvent const&)
  {
