...
void emb::tests::chrono_test() {
    ...
    EMB_MAYBE_UNUSED emb::chrono::nanoseconds nsec = emb::chrono::duration_cast<emb::chrono::nanoseconds>(usec);
    EMB_ASSERT_EQUAL(nsec.count(), 10000000000);

    EMB_ASSERT_EQUAL(msec - emb::chrono::milliseconds(1), emb::chrono::milliseconds(9999));

    EMB_MAYBE_UNUSED emb::chrono::milliseconds msec2 = msec + emb::chrono::milliseconds(1);
